...
const MILESTONES = [
   ...
   { year: '2019', role: 'Baker', company: 'Warburtons', type: 'Promotion', desc: 'Promoted following a successful 18% cycle time reduction project. Took ownership of all sourdough product lines.', icon: '🚀', color: '#FF2D78', product: '🥖' },
