...
export default function LayersOfLamination() {
         ...
         >
            <div className="sticky top-0 h-screen w-full flex items-center overflow-hidden">
               ...
               >
                  ...
                  <div className="w-[95vw] sm:w-[80vw] md:w-[70vw] lg:w-[55vw] h-full flex flex-col items-start justify-center pr-[15vw] md:pr-[10vw] relative shrink-0">
                     <h2 className="font-display text-[4rem] md:text-[8rem] lg:text-[10rem] font-bold leading-none tracking-tighter text-[#FFF8F0] mb-6">
                        Layers of<br />
                        <span className="text-[#FFD23F] italic font-light">Lamination</span>
                     </h2>
                  ...
                  <div className="flex items-center gap-12 sm:gap-20 md:gap-32 pr-[15vw] shrink-0 pl-[25vw] sm:pl-[20vw] md:pl-[15vw]">
